...
def test_group_no_send_session():
    ...
    with pytest.raises(SignalProtocolException, match="missing sender key state for distribution"):
        group_encrypt(alice_store, sender_address, "a6fe9593-2ca5-41bc-99e9-60a436fbef77", "hello".encode("utf8"))
...
def test_group_basic_encrypt_decrypt():
    ...
    sent_distribution_message = create_sender_key_distribution_message(
        sender_address, "a6fe9593-2ca5-41bc-99e9-60a436fbef77", alice_store
    )
    recv_distribution_message = SenderKeyDistributionMessage.try_from(
        sent_distribution_message.serialized()
    )

    alice_ciphertext = group_encrypt(alice_store, sender_address, "a6fe9593-2ca5-41bc-99e9-60a436fbef77", "hello".encode("utf8"))
...
def test_group_large_message():
    ...
    alice_ciphertext = group_encrypt(alice_store, sender_address, "a6fe9593-2ca5-41bc-99e9-60a436fbef77", large_message)
...
def test_group_basic_ratchet():
    ...
    alice_ciphertext_1 = group_encrypt(
        alice_store, sender_address, "a6fe9593-2ca5-41bc-99e9-60a436fbef77", "message 1".encode("utf8")
    )
    alice_ciphertext_2 = group_encrypt(
        alice_store, sender_address, "a6fe9593-2ca5-41bc-99e9-60a436fbef77", "message 2".encode("utf8")
    )
    alice_ciphertext_3 = group_encrypt(
        alice_store, sender_address, "a6fe9593-2ca5-41bc-99e9-60a436fbef77", "message 3".encode("utf8")
    )
...
def test_group_late_join():
    ...
    for i in range(100):
        group_encrypt(alice_store, sender_address, "a6fe9593-2ca5-41bc-99e9-60a436fbef77", f"message {i}/100".encode("utf8"))
    ...
    alice_ciphertext = group_encrypt(
        alice_store, sender_address, "a6fe9593-2ca5-41bc-99e9-60a436fbef77", "welcome Bob!".encode("utf8")
    )
...
def test_group_out_of_order():
    ...
    for i in range(100):
        ooo_ciphertexts.append(
            group_encrypt(alice_store, sender_address, "a6fe9593-2ca5-41bc-99e9-60a436fbef77", f"{i}".encode("utf8"))
        )
...
def test_group_too_far_in_the_future():
    ...
    for i in range(25001):
        group_encrypt(alice_store, sender_address, "a6fe9593-2ca5-41bc-99e9-60a436fbef77", f"this is message {i}".encode("utf8"))

    alice_ciphertext = group_encrypt(
        alice_store, sender_address, "a6fe9593-2ca5-41bc-99e9-60a436fbef77", "hello????".encode("utf8")
    )
...
def test_group_message_key_limit():
    ...
    for i in range(2010):
        ciphertexts.append(
            group_encrypt(alice_store, sender_address, "a6fe9593-2ca5-41bc-99e9-60a436fbef77", "too many msg".encode("utf8"))
        )
